...
namespace Yookey.WisdomClassed.SIP.Model.Crm
{
    ...
    public class CrmCompanyEntity : ModelImp.BaseModel<CrmCompanyEntity>
    {
		...
		/// <summary>
		/// Parm IsAcceptLicense
		/// </summary>
		public const string Parm_CrmCompany_IsAcceptLicense = "IsAcceptLicense";
		/// <summary>
		/// Parm IsArea
		/// </summary>
		public const string Parm_CrmCompany_IsArea = "IsArea";
		/// <summary>
		/// Parm Manager
		/// </summary>
        ...
        /// Parm IsLedger
        /// </summary>
        public const string Parm_CrmCompany_IsLedger = "IsLedger";
		/// <summary>
		/// Parm RowStatus
		/// </summary>
		...
		private int _isAcceptLicense;
		/// <summary>
		/// 是否接收许可派件
		/// </summary>
		public int IsAcceptLicense
		{
			get{return _isAcceptLicense;}
			set{_isAcceptLicense = value;}
		}
        /// <summary>
        /// 是否设置为电子台账单位
        /// </summary>
		...
		public override CrmCompanyEntity SetModelValueByDataRow(DataRow dr, IList<string> fields)
        {
            var tmp = new CrmCompanyEntity();
          			if (fields.Contains(Parm_CrmCompany_Id) || fields.Contains("*"))
				tmp.Id = dr[Parm_CrmCompany_Id].ToString();
			if (fields.Contains(Parm_CrmCompany_ParentId) || fields.Contains("*"))
				tmp.ParentId = dr[Parm_CrmCompany_ParentId].ToString();
			if (fields.Contains(Parm_CrmCompany_Category) || fields.Contains("*"))
				tmp.Category = dr[Parm_CrmCompany_Category].ToString();
			if (fields.Contains(Parm_CrmCompany_Code) || fields.Contains("*"))
				tmp.Code = dr[Parm_CrmCompany_Code].ToString();
			if (fields.Contains(Parm_CrmCompany_FullName) || fields.Contains("*"))
				tmp.FullName = dr[Parm_CrmCompany_FullName].ToString();
			if (fields.Contains(Parm_CrmCompany_ShortName) || fields.Contains("*"))
				tmp.ShortName = dr[Parm_CrmCompany_ShortName].ToString();
			if (fields.Contains(Parm_CrmCompany_Nature) || fields.Contains("*"))
				tmp.Nature = dr[Parm_CrmCompany_Nature].ToString();
			if (fields.Contains(Parm_CrmCompany_Manager) || fields.Contains("*"))
				tmp.Manager = dr[Parm_CrmCompany_Manager].ToString();
			if (fields.Contains(Parm_CrmCompany_Contact) || fields.Contains("*"))
				tmp.Contact = dr[Parm_CrmCompany_Contact].ToString();
			if (fields.Contains(Parm_CrmCompany_Phone) || fields.Contains("*"))
				tmp.Phone = dr[Parm_CrmCompany_Phone].ToString();
			if (fields.Contains(Parm_CrmCompany_Fax) || fields.Contains("*"))
				tmp.Fax = dr[Parm_CrmCompany_Fax].ToString();
			if (fields.Contains(Parm_CrmCompany_Email) || fields.Contains("*"))
				tmp.Email = dr[Parm_CrmCompany_Email].ToString();
			if (fields.Contains(Parm_CrmCompany_ProvinceId) || fields.Contains("*"))
				tmp.ProvinceId = dr[Parm_CrmCompany_ProvinceId].ToString();
			if (fields.Contains(Parm_CrmCompany_Province) || fields.Contains("*"))
				tmp.Province = dr[Parm_CrmCompany_Province].ToString();
			if (fields.Contains(Parm_CrmCompany_CityId) || fields.Contains("*"))
				tmp.CityId = dr[Parm_CrmCompany_CityId].ToString();
			if (fields.Contains(Parm_CrmCompany_City) || fields.Contains("*"))
				tmp.City = dr[Parm_CrmCompany_City].ToString();
			if (fields.Contains(Parm_CrmCompany_CountyId) || fields.Contains("*"))
				tmp.CountyId = dr[Parm_CrmCompany_CountyId].ToString();
			if (fields.Contains(Parm_CrmCompany_County) || fields.Contains("*"))
				tmp.County = dr[Parm_CrmCompany_County].ToString();
			if (fields.Contains(Parm_CrmCompany_Address) || fields.Contains("*"))
				tmp.Address = dr[Parm_CrmCompany_Address].ToString();
			if (fields.Contains(Parm_CrmCompany_AccountInfo) || fields.Contains("*"))
				tmp.AccountInfo = dr[Parm_CrmCompany_AccountInfo].ToString();
			if (fields.Contains(Parm_CrmCompany_Postalcode) || fields.Contains("*"))
				tmp.Postalcode = dr[Parm_CrmCompany_Postalcode].ToString();
			if (fields.Contains(Parm_CrmCompany_Web) || fields.Contains("*"))
				tmp.Web = dr[Parm_CrmCompany_Web].ToString();
			if (fields.Contains(Parm_CrmCompany_Remark) || fields.Contains("*"))
				tmp.Remark = dr[Parm_CrmCompany_Remark].ToString();
			if (fields.Contains(Parm_CrmCompany_Enforcement) || fields.Contains("*"))
				tmp.Enforcement = int.Parse(dr[Parm_CrmCompany_Enforcement].ToString());
			if (fields.Contains(Parm_CrmCompany_IsArea) || fields.Contains("*"))
				tmp.IsArea = int.Parse(dr[Parm_CrmCompany_IsArea].ToString());
			if (fields.Contains(Parm_CrmCompany_IsAcceptLicense) || fields.Contains("*"))
				tmp.IsAcceptLicense = int.Parse(dr[Parm_CrmCompany_IsAcceptLicense].ToString());
			if (fields.Contains(Parm_CrmCompany_Enabled) || fields.Contains("*"))
				tmp.Enabled = int.Parse(dr[Parm_CrmCompany_Enabled].ToString());
			if (fields.Contains(Parm_CrmCompany_SortCode) || fields.Contains("*"))
				tmp.SortCode = int.Parse(dr[Parm_CrmCompany_SortCode].ToString());
			if (fields.Contains(Parm_CrmCompany_DeleteMark) || fields.Contains("*"))
				tmp.DeleteMark = int.Parse(dr[Parm_CrmCompany_DeleteMark].ToString());
			if (fields.Contains(Parm_CrmCompany_CreateDate) || fields.Contains("*"))
				tmp.CreateDate = DateTime.Parse(dr[Parm_CrmCompany_CreateDate].ToString());
			if (fields.Contains(Parm_CrmCompany_CreateUserId) || fields.Contains("*"))
				tmp.CreateUserId = dr[Parm_CrmCompany_CreateUserId].ToString();
			if (fields.Contains(Parm_CrmCompany_CreateUserName) || fields.Contains("*"))
				tmp.CreateUserName = dr[Parm_CrmCompany_CreateUserName].ToString();
			if (fields.Contains(Parm_CrmCompany_ModifyDate) || fields.Contains("*"))
				tmp.ModifyDate = DateTime.Parse(dr[Parm_CrmCompany_ModifyDate].ToString());
			if (fields.Contains(Parm_CrmCompany_ModifyUserId) || fields.Contains("*"))
				tmp.ModifyUserId = dr[Parm_CrmCompany_ModifyUserId].ToString();
			if (fields.Contains(Parm_CrmCompany_ModifyUserName) || fields.Contains("*"))
				tmp.ModifyUserName = dr[Parm_CrmCompany_ModifyUserName].ToString();
			if (fields.Contains(Parm_CrmCompany_RowStatus) || fields.Contains("*"))
				tmp.RowStatus = int.Parse(dr[Parm_CrmCompany_RowStatus].ToString());
			if (fields.Contains(Parm_CrmCompany_Version) || fields.Contains("*"))
			{
				var bts = (byte[])(dr[Parm_CrmCompany_Version]);
				Array.Reverse(bts);
				tmp.Version = BitConverter.ToInt64(bts, 0);
			}
			if (fields.Contains(Parm_CrmCompany_CreatorId) || fields.Contains("*"))
				tmp.CreatorId = dr[Parm_CrmCompany_CreatorId].ToString();
			if (fields.Contains(Parm_CrmCompany_CreateBy) || fields.Contains("*"))
				tmp.CreateBy = dr[Parm_CrmCompany_CreateBy].ToString();
			if (fields.Contains(Parm_CrmCompany_CreateOn) || fields.Contains("*"))
				tmp.CreateOn = DateTime.Parse(dr[Parm_CrmCompany_CreateOn].ToString());
			if (fields.Contains(Parm_CrmCompany_UpdateId) || fields.Contains("*"))
				tmp.UpdateId = dr[Parm_CrmCompany_UpdateId].ToString();
			if (fields.Contains(Parm_CrmCompany_UpdateBy) || fields.Contains("*"))
				tmp.UpdateBy = dr[Parm_CrmCompany_UpdateBy].ToString();
			if (fields.Contains(Parm_CrmCompany_UpdateOn) || fields.Contains("*"))
		...
		public override SqlParameter[] SetParmsValueByModelForAdd(CrmCompanyEntity crmcompany, SqlParameter[] parms)
		{
				...
				parms[23].Value = crmcompany.IsArea;
				parms[24].Value = crmcompany.IsAcceptLicense;
				parms[25].Value = crmcompany.Enabled;
				parms[26].Value = crmcompany.SortCode;
				parms[27].Value = crmcompany.DeleteMark;
				parms[28].Value = crmcompany.CreateDate;
				parms[29].Value = crmcompany.CreateUserId;
				parms[30].Value = crmcompany.CreateUserName;
				parms[31].Value = crmcompany.ModifyDate;
				parms[32].Value = crmcompany.ModifyUserId;
				parms[33].Value = crmcompany.ModifyUserName;
				parms[34].Value = crmcompany.RowStatus;
				parms[35].Value = crmcompany.CreatorId;
				parms[36].Value = crmcompany.CreateBy;
				parms[37].Value = crmcompany.CreateOn;
				parms[38].Value = crmcompany.UpdateId;
				parms[39].Value = crmcompany.UpdateBy;
				parms[40].Value = crmcompany.UpdateOn;
                parms[41].Value = crmcompany.Id;
		...
		public override SqlParameter[] GetParms()
        {
	     	try
	     	{
				...
				if (parms == null)
				{
					...
					new SqlParameter(Parm_CrmCompany_IsArea, SqlDbType.Int, 10),
					new SqlParameter(Parm_CrmCompany_IsAcceptLicense, SqlDbType.Int, 10),
