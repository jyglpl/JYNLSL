//-------------------------------------------------------------------------
// <copyright  company="友科软件" file="VerificationStringHelp.cs">
//  Copyright (c) 版本 V1
//  所属部门：技术部
//  所属项目：智慧城管
//  作    者：周 鹏
...
{
    public class VerificationStringHelp
    {
        /// <summary>
        ...
        /// <summary>
        /// 获取用于判断包含正负和零的浮点数的正则表达式(包含0) 
        /// </summary>
        public const string InculudeAllDecimalRegex = @"^(-?\d+)(\.\d+)?$";
        ...
        /// 获取用于判断电话的正则表达式
        /// </summary>
        public const string CheckPhoneRegex = @"^((\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)";
    }
}
