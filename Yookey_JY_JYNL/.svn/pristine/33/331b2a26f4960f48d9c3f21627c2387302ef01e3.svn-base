//-------------------------------------------------------------------------
// <copyright  company="友科软件" file="FE_WorkListBll.cs">
//  Copyright (c) 版本 V1
//  所属部门：技术部
//  所属项目：智慧城管
//  作    者：周 鹏
//  创建日期：2014/7/16 16:58:36
//  功能描述：FE_WorkList业务逻辑类
//  版本历史:
...
namespace Yookey.WisdomClassed.SIP.Business.FlowEditor
{
    ...
    /// FE_WorkList业务逻辑
    /// </summary>
    public class FeWorkListBll : BaseBll<FeWorkListEntity>
    {
        public FeWorkListBll()
        {
            BaseDal = new FeWorkListDal();
        }
