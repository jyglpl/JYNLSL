...
namespace Yookey.WisdomClassed.SIP.Business.Com
{
    public class ComInitial
    {
        ...
        {
            var defaultChar =GetDefaultChar(CnChar);
        ...
        /// <returns></returns>
        private string GetDefaultChar(string word)
        {
            var wordChar = new Dictionary<string, string>();
            wordChar.Add("阊","C");
            wordChar.Add("葑", "F");
            return wordChar.FirstOrDefault(i => i.Key.Contains(word)).Value;            
        }
    }
}
